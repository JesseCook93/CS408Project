...
if echo "$help_output" | grep -q "Build script commands:"; then
...
commands=("env" "e" "new" "n" "login" "l" "docker" "dk" "ec2" "ec" "init" "i" "up" "u" "down" "d" "build" "b" "push" "p" "deploy" "y" "logs" "lg" "clean" "c" "nuke" "x" "help" "h")
